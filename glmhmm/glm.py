...
class GLM(object):
    ...
    def neglogli(self,x,w,y,reshape_weights = False):
        """
        ...
        phi = self.compObs(x,w,normalize=False) 
    ...
    def fit(self,x,w,y,compHess = False):
        ...
        opt_log = lambda w: self.neglogli(x,w,y,reshape_weights=True) # calculate log likelihood 
